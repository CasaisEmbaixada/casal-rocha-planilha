...
const getRecommendationData = (percentage: number, type: 'planning' | 'transactions') => {
  ...
  if (isPositive) {
    ...
    const negativeMessages = {
      planning: {
        10: { icon: AlertCircle, color: "text-yellow-600", bg: "bg-yellow-50", title: "Atenção ao planejamento", message: "Cuidado! Você está planejando gastar 10% a mais do que ganha. Revise alguns gastos para evitar problemas futuros." },
        20: { icon: AlertCircle, color: "text-yellow-600", bg: "bg-yellow-50", title: "Ajustes necessários", message: "Alerta! 20% de déficit planejado pode gerar dívidas. Corte gastos não essenciais e priorize apenas o fundamental." },
        30: { icon: AlertTriangle, color: "text-orange-600", bg: "bg-orange-50", title: "Situação preocupante", message: "Atenção! 30% de déficit é preocupante. Revise urgentemente seu orçamento e considere fontes extras de renda." },
        40: { icon: AlertTriangle, color: "text-orange-600", bg: "bg-orange-50", title: "Risco elevado", message: "Cuidado! 40% de déficit pode levar ao endividamento. Corte gastos drásticos e busque orientação financeira." },
        50: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Situação crítica", message: "Alerta máximo! 50% de déficit é insustentável. Reestruture completamente seu orçamento e busque ajuda profissional." },
        60: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Emergência financeira", message: "Situação crítica! 60% de déficit exige ação imediata. Corte todos os gastos supérfluos e busque renda extra urgentemente." },
        70: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Risco extremo", message: "Perigo! 70% de déficit pode levar à falência pessoal. Tome medidas drásticas de corte e procure ajuda especializada." },
        80: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Colapso iminente", message: "Situação desesperadora! 80% de déficit indica colapso financeiro iminente. Ação emergencial é necessária agora!" },
        90: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Catástrofe anunciada", message: "Estado crítico! 90% de déficit é catastrófico. Pare tudo e reorganize sua vida financeira completamente." },
        100: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Falência total", message: "Colapso total! Você está gastando o dobro do que ganha. Busque ajuda profissional urgente e reestruture tudo." }
      },
      transactions: {
        10: { icon: AlertCircle, color: "text-yellow-600", bg: "bg-yellow-50", title: "Mês no vermelho", message: "Atenção! Você gastou 10% a mais do que ganhou. Ajuste os gastos do próximo mês para compensar." },
        20: { icon: AlertCircle, color: "text-yellow-600", bg: "bg-yellow-50", title: "Déficit preocupante", message: "Cuidado! 20% de déficit real afeta sua estabilidade. Revise seus gastos e seja mais rigoroso no orçamento." },
        30: { icon: AlertTriangle, color: "text-orange-600", bg: "bg-orange-50", title: "Situação complicada", message: "Alerta! 30% de déficit real compromete suas finanças. Faça ajustes urgentes e evite novos gastos desnecessários." },
        40: { icon: AlertTriangle, color: "text-orange-600", bg: "bg-orange-50", title: "Mês muito difícil", message: "Situação grave! 40% de déficit real exige medidas corretivas imediatas. Reavalie todas as suas despesas." },
        50: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Mês catastrófico", message: "Crítico! 50% de déficit real é insustentável. Você precisa de um plano de recuperação urgente." },
        60: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Colapso financeiro", message: "Emergência! 60% de déficit real indica perda total de controle. Busque ajuda profissional imediatamente." },
        70: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Desastre completo", message: "Situação desesperadora! 70% de déficit real exige reestruturação total da sua vida financeira." },
        80: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Falência pessoal", message: "Estado crítico! 80% de déficit real indica falência pessoal. Tome medidas extremas agora!" },
        90: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Ruína financeira", message: "Colapso total! 90% de déficit real representa ruína financeira. Reorganize sua vida completamente." },
        100: { icon: XCircle, color: "text-red-600", bg: "bg-red-50", title: "Catástrofe absoluta", message: "Situação impossível! Você gastou o dobro da sua renda. Busque ajuda especializada urgentemente!" }
      }
    };
